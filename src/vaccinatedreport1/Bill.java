...
public class Bill extends javax.swing.JFrame {
    ...
    private void billHeader(){
        jTextArea1.setText("       =============================="+"\n"+
                "           1st DOSE VACCINATION REPORT "+"\n"+"                Contact Number: 0123456789"+"\n"+
                            "                           Address:200A,"+jTextHos.getText()+"\n"+
                "                          New Delhi,India"+"\n"+
                "        ==============================="+
                "\n");
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addComponent(jTextHos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36)
                .addComponent(jButtonAdd)
    ...
    String Adhar=UID_Form.jTextAdhr.getText();
        try{
            ...
            String reg_SQL = "SELECT * FROM Tab_Dose1 WHERE Adhr = '" + Adhar + "'";
            ...
            if(reg_rs.next())
            {
                ...
                jTextHos.setText(reg_rs.getString("HosDes"));
            }
            reg_rs.close();
        }
        catch (Exception e)
